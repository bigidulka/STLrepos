...
void main()
{
...
#endif // STL_ARRAY
#ifdef STL_VECTOR
	//vector - это контейнер, который хранит данные в виде динамического массав.
	...
	do 
	{
		...
		if (index > vec.size())cout << "Давай меньше\n";
	...
	print_vector(vec);
	vector_properties(vec);
	cout << "Пустой вектор занимает: " << sizeof(vec) << " Байт";
	cout << DELIM;
	vector<int> vec2;
	cout << "Пустой вектор занимает: " << sizeof(vec2) << " Байт";*/
#ifdef VECTOR_SWAP
	...
	cout << "Введите начало и конец удаляемого диапазона: "; cin >> index_start >> index_end;
